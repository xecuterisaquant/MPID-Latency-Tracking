...
author: "[Your Name], University of Illinois"
date: "December 20, 2025"
abstract: |
   This study measures the reaction time of NASDAQ Market Participant Identifiers (MPIDs) to external price shocks originating from CME E-mini S&P 500 futures (ES) trades. We define stimulus as ES trade events (LastTradeMsg) and response as the first subsequent add, cancel, or replace action by an MPID on NASDAQ XNAS. Using nanosecond-precision timestamps from market data feeds, we compute per-MPID latency distributions and examine temporal patterns across trading hours. Analyzing 541,844 ES trades and 30.7 million NASDAQ MPID events from March 10, 2025, we document 11.9 million latency measurements across 51 distinct MPIDs. Our findings reveal extreme heterogeneity: the fastest MPIDs (WCHV, WBPX, JPMS) exhibit median reaction times of 14-16 microseconds, while slower participants exceed 4 milliseconds. We observe that 93% of responses are Replace events, indicating continuous quote adjustment rather than order cancellation. These results provide empirical evidence of ultra-low-latency liquidity provision and document significant speed advantages among top-tier market makers.
...
**Collection period:** March 10, 2025 (06:00-16:39 UTC)  
**Message types used:** LastTradeMsg (trade executions only)  
**Total ES trades analyzed:** 541,844  
...
**Total NASDAQ MPID events analyzed:** 30,676,405 events across target symbolsodification
...
analyzed: 541,844 (single day: March 10, 2025)
- NASDAQ MPID messages analyzed: 30,676,405 (filtered to 10 target symbols with MPID attribution)
- Total latency measurements generated: 11,861,028
- Dataset size: ~350 MB compressed (Parquet format with Snappy compression)timate ~50,000-100,000 for liquid hours)
...
:**
- **SPY:** SPDR S&P 500 ETF Trust — largest ETF, direct S&P 500 exposure
- **QQQ:** Invesco QQQ Trust — NASDAQ-100 ETF
- **IWM:** iShares Russell 2000 ETF — small-cap exposure
- **AAPL:** Apple Inc. — largest market cap equity
- **MSFT:** Microsoft Corporation — mega-cap technology
- **NVDA:** NVIDIA Corporation — high-momentum semiconductor
- **TSLA:** Tesla Inc. — highly volatile, high retail interest
- **AMZN:** Amazon.com Inc. — mega-cap technology
- **GOOGL:** Alphabet Inc. — mega-cap technology
- **META:** Meta Platforms Inc. — mega-cap social mediatail/institutional interest
...
1. **WCHV** (Wolverine) — 4,145,263 measurements (34.95%), median 16.4μs
2. **WBPX** (Wedbush) — 3,543,352 measurements (29.87%), median 15.1μs
3. **JPMS** (JP Morgan Securities) — 3,166,908 measurements (26.70%), median 14.3μs
4. **IMCC** (IMC Chicago) — 397,111 measurements (3.35%), median 4,174μs
5. **ETMM** (Electronic Trading & Market Making) — 115,230 measurements (0.97%), median 4,539μs
6. **GSCO** (Goldman Sachs) — 88,314 measurements (0.74%), median 4,477μs
7. **FLTU** (Flow Traders US) — 48,437 measurements (0.41%), median 3,939μs
8. **UBSS** (UBS Securities) — 46,628 measurements (0.39%), median 1,907μs
9. **SGAS** (Susquehanna) — 42,581 measurements (0.36%), median 3,664μs
10. **CDRG** (Citadel) — 29,486 measurements (0.25%), median 3,564μs  

**Total unique MPIDs:** 51 (remainder account for <0.5% of activity)
**Rationale:**  
